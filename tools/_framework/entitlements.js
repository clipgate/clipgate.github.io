...
export const TOOLS = [
  ...
  { slug: 'base64',       name: 'Base64 Encode/Decode', tagline: 'Convert between text, bytes, and Base64.',                  status: 'planned', category: 'Data',       icon: '64' },
  { slug: 'url',          name: 'URL Encode/Decode',    tagline: 'Encode and decode URL components.',                         status: 'planned', category: 'Web',        icon: '⇆' },
  { slug: 'uuid',         name: 'UUID Generator',       tagline: 'Generate v1, v4, and v7 UUIDs.',                            status: 'planned', category: 'Data',       icon: 'ID' },
  { slug: 'timestamp',    name: 'Timestamp Converter',  tagline: 'Convert between Unix, ISO, and human-readable timestamps.', status: 'planned', category: 'Data',       icon: '⏱' },
